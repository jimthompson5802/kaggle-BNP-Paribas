...
train.raw <- data.frame(train.raw[sample(nrow(train.raw),0.9*nrow(train.raw))],stringsAsFactors = FALSE)
```
...
df <- gather(train.raw[,c(predictor.vars,"ID","target")], feature, value, one_of(predictor.vars))
