...
WORK.DIR <- "./src/L1_rf1"  # modify to specify directory to contain model artififacts
...
MODEL.SPECIFIC.PARMS <- list(do.trace=FALSE,ntree=5000) #NULL # Other model specific parameters
