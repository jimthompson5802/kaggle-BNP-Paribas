...
WORK.DIR <- "./src/L1_skeleton_model"  # modify to specify directory to contain model artififacts
...
PREPARE.MODEL.DATA <- prepL1SkltnModelData

MODEL.COMMENT <- "testing setup for Level 1"
