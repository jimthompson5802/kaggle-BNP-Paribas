...
train2.raw <- train.raw[as.vector(-idx)]

nrow(do.call(rbind,list(train1.raw,train2.raw,calib.raw,test.raw)))
...
save(train1.raw,train2.raw,calib.raw,test.raw,file=paste0(data.dir,"/train_calib_test.RData"))
